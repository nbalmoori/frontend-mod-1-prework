...
//0, 1 and 2 are logged to the console, because the code says to log the value of i. The initialization states that i initially equals 0, and the code is to update the value of i by one until the condition breaks at 3.
